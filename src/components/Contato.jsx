...
export default function Contato({ onOpenPopup }) {
    ...
    <section id="contato" className="relative bg-bg2 overflow-hidden py-32 px-[8vw]" aria-labelledby="contato-title">
      ...
      <div className="relative max-w-[1000px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
        ...
        <div className="reveal">
          ...
          <button
            onClick={onOpenPopup}
            className="inline-flex items-center gap-4 px-8 py-[1.1rem] bg-wpp-dk text-white no-underline font-label text-[.7rem] tracking-[.18em] uppercase transition-all duration-200 hover:opacity-90 hover:-translate-y-0.5 border-0 cursor-pointer"
        ...
        {submitted ? (
          <div className="reveal flex flex-col items-center justify-center text-center p-10 bg-bg3 border border-gold/30 min-h-[400px] animate-[fadeIn_.5s_ease]">
            ...
            <p className="text-muted text-[.9rem] leading-relaxed max-w-[30ch]">
              Recebemos seus dados. Um consultor entrará em contato em breve via WhatsApp.
            </p>
            <button 
              onClick={() => setSubmitted(false)}
              className="mt-8 font-label text-[.6rem] tracking-[.2em] uppercase text-gold hover:text-cream transition-colors"
            >
          ...
          >
            ...
            <button
              type="submit"
              disabled={loading}
              className="mt-2 py-4 px-8 font-label text-[.7rem] tracking-[.2em] uppercase border-0 cursor-pointer transition-all duration-200 hover:opacity-85 hover:-translate-y-0.5 disabled:opacity-50 disabled:translate-y-0"
