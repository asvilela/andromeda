      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        ...
        >
          ...
          <form id="form-whatsapp" onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              <label htmlFor="wa-fullName" className="font-sans font-medium text-[.72rem] tracking-[.18em] uppercase text-text-2 mb-2 block">Nome completo</label>
              <input
                id="wa-fullName"
                required
                name="fullName"
            ...
            <div>
              <label htmlFor="wa-phoneMobile" className="font-sans font-medium text-[.72rem] tracking-[.18em] uppercase text-text-2 mb-2 block">WhatsApp</label>
              <input
                id="wa-phoneMobile"
                required
                name="phoneMobile"
